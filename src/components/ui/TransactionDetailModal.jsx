                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex justify-between items-center">
                            <div className="flex flex-col">
                                <span className="text-[10px] text-muted font-bold uppercase">Date & Time</span>
                        ...
                        <div style={{ borderTop: '1px solid #F1F1F0', paddingTop: '16px' }}>
                            <span className="text-[10px] text-muted font-bold uppercase">Total Amount</span>
                            <div className="flex items-baseline gap-1">
                                <span className="text-3xl font-black">-${transaction.amount.toFixed(2)}</span>
                                <span className="text-sm text-muted font-bold">USD</span>
                            </div>
                        </div>
