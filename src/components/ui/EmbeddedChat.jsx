...
export function EmbeddedChat({ children, contextStarters = [], initialMessage = "How can I help with this?", context = {} }) {
    ...
    return (
        <div style={{
            ...
            {/* Scrollable Content Area (Data + Messages) */}
            <div
                ref={scrollRef}
                style={{
                    flex: 1,
            ...
            >
                <div style={{ padding: '16px 16px' }}>
                    ...
                    <div style={{ marginTop: children ? '24px' : '0' }}>
